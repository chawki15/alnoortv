  ...
  <div class="wrapper">
    ...
    <main id="content">
      <div class="bn-breaking-news" id="newsTicker2">
        ...
        <div class="bn-news">
          <ul>
            <?php list($id,$titre) = GetMustajidaat($db); for($i=0;$i<sizeof($id);$i++){ ?>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12">
              <div>
                <div class="callbacks_container">
                  <div class="slider">
                    <?php list($id,$titre,$photo,$date) =  GetLatestNews($db); for($i=0;$i<sizeof($id);$i++){ ?>
                    <div class="slide">
                      <a href="<?php echo 'news/'.cripter($id[$i],264).'-'.replace($titre[$i]).'.html';  ?>"
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
              ...
              <div class="row">
                <?php list($id,$titre,$photo,$date) = GetZweiNews($db,'1'); $f=NbrAkhbar($db,"1"); if( $f != "0" ){
      ...
      <div class="container">
        <div class="row">
          <div class="group-item col-sm-12 col-md-4 col-xl-4 category-histoire bloc_col">
            ...
            <?php list($id,$titre,$photo,$date) = GetFunfNews($db,'2'); $f=NbrAkhbar($db,"2"); if( $f != "0" ){
          ...
          <div class="group-item col-sm-12 col-md-4 col-xl-4 category-%d8%b2%d9%88%d9%88%d9%85 bloc_col">
            ...
            <?php list($id,$titre,$photo,$date) = GetFunfNews($db,'3'); $f=NbrAkhbar($db,"3"); if( $f != "0" ){
              for($i=0;$i<sizeof($id);$i=$i+5){ ?>
            <div class="card horizontal-card">
              <div class="card-body">
                <h3 class="card-title">
          ...
          <div class="group-item col-sm-12 col-md-4 col-xl-4 category-interviews bloc_col">
            ...
            <?php list($id,$titre,$photo,$date) = GetFunfNews($db,'4'); $f=NbrAkhbar($db,"4"); if( $f != "0" ){
              for($i=0;$i<sizeof($id);$i=$i+5){ ?>
            <div class="card horizontal-card">
              <div class="card-body">
                <h3 class="card-title">
        ...
        <div class="container">
          <div class="media-item category-social-video bloc_col">
            ...
            <div class="video-section row carousel">
              <?php list($id,$titre,$photo,$url) = GetVideo($db); $f=GetTotalVideo($db); if( $f != "0" ){
              for($i=0;$i<sizeof($id);$i++){ ?>
      ...
      <div class="container">
        <div class="row">
          <div class="group-item col-sm-12 col-md-4 col-xl-4 category-histoire bloc_col">
            ...
            <?php list($id,$titre,$photo,$date) = GetFunfNews($db,'6'); $f=NbrAkhbar($db,"6"); if( $f != "0" ){
              for($i=0;$i<sizeof($id);$i=$i+5){ ?>
            <div class="card horizontal-card">
              <div class="card-body">
                <h3 class="card-title">
          ...
          <div class="group-item col-sm-12 col-md-4 col-xl-4 category-interviews bloc_col">
            ...
            <?php list($id,$titre,$photo,$date) = GetFunfNews($db,'10'); $f=NbrAkhbar($db,"10"); if( $f != "0" ){
              for($i=0;$i<sizeof($id);$i=$i+5){ ?>
            <div class="card horizontal-card">
              <div class="card-body">
                <h3 class="card-title">
          ...
          <div class="group-item col-sm-12 col-md-4 col-xl-4 category-%d8%b2%d9%88%d9%88%d9%85 bloc_col">
            ...
            <?php list($id,$titre,$photo,$date) = GetFunfNews($db,'9'); $f=NbrAkhbar($db,"9"); if( $f != "0" ){
              for($i=0;$i<sizeof($id);$i=$i+5){ ?>
            <div class="card horizontal-card">
              <div class="card-body">
                <h3 class="card-title">
      ...
      <div class="container">
        <div class="sport-box category-sport bloc_col">
          ...
          <div class="row">
            <?php list($id,$titre,$photo,$date) = GetFunfNews($db,'5'); $f=NbrAkhbar($db,"5"); if( $f != "0" ){
              for($i=0;$i<sizeof($id);$i=$i+5){ ?>
        ...
        <div class="container">
          <div class="media-item category-social-video bloc_col">
            ...
            <div class="video-section row carouselAraa">
              <?php  list($id,$idwriter,$titre) = GetOpinion($db); for($m=0;$m<sizeof($id);$m++){ ?>
              <div class="col-12 col-sm-6 col-md-6 col-xl-4">
                <a href="<?php echo  'opinion/'.cripter($id[$m],264).'-'.replace($titre[$m]).'.html'; ?>"
                  class="plate-article">
                  <div class="plate-article__img bg js-lazy-me"
                    data-lazy-source="<?php  echo'assets/img/writers/'. GetTableByID($db,'writers','photo',$idwriter[$m]) ?>"
                    style="background-image: url(<?php  echo 'assets/img/writers/'. GetTableByID($db,'writers','photo',$idwriter[$m]) ?>);">
                  </div>
                  <div class="plate-article__name icon-quote-right">
                    <?php  echo GetTableByID($db,'writers','nom',$idwriter[$m]) ?>
                  </div>
        ...
        <div class="container">
          <div class="row">
            <section class="col-sm-12 col-md-4 col-xl-4 bloc_col popular-posts">
              ...
              <?php list($id,$titre,$photo,$date) = GetFunfNews($db,'7'); $f=NbrAkhbar($db,"7"); if( $f != "0" ){
                for($i=0;$i<sizeof($id);$i++){ ?>
                  <div class="card">
                    <div class="card-img-top">
                      <div class="ratio-medium">
            ...
            <section class="col-sm-12 col-md-4 col-xl-4 bloc_col popular-posts">
              ...
              <?php list($id,$titre,$photo,$date) = GetFunfNews($db,'13'); $f=NbrAkhbar($db,"13"); if( $f != "0" ){
                for($i=0;$i<sizeof($id);$i++){ ?>
              <div class="card">
                <div class="card-img-top">
                  <div class="ratio-medium">
            ...
            <section class="col-sm-12 col-md-4 col-xl-4 bloc_col popular-posts">
              ...
              <?php list($id,$titre,$photo,$date) = GetFunfNews($db,'14'); $f=NbrAkhbar($db,"14"); if( $f != "0" ){
                for($i=0;$i<sizeof($id);$i++){ ?>
              <div class="card">
                <div class="card-img-top">
                  <div class="ratio-medium">
      ...
      <div class="container">
        <div class="sport-box category-sport bloc_col">
          ...
          <div class="row">
            <div class="col-12 col-md-6 thumbnail-feature">
              <div class="slider-6">
                <?php  list($id,$photo,$titre) = GetInfo($db);  for($n=0;$n<sizeof($id);$n++){ ?>
                <div>
