          ...
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">تعديل الفئة فرعية
                </li>
              </ol>
            </div>
          </div>
                    ...
                    <input type="hidden" name="id" value="<?php echo htmlspecialchars((string)($uId ?? ''), ENT_QUOTES, 'UTF-8'); ?>">
                      <div class="form-body">
                          ...
                          <div class="col-md-9">
                            <select class="form-control" name="selectCategory" id="selectCategory">
                                ...
                                <?php 
                                    ...
                                    {
                                      if($id[$i] == $cat){ ?>
                                <option value="<?php echo $id[$i] ?>" selected ><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php  echo $name[$i] ?></font></font></option>
                                <?php  }else{ ?> 
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <input type="text" class="form-control" placeholder="اسم الفئة الفرعية" value="<?php echo $nom ?>" name="sousCategory" id="sousCategory">
