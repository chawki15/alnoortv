          ...
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">تعديل رأي جديد
                </li>
              </ol>
            </div>
          </div>
              ...
              <div class="card">
                <div class="card-content collpase show">
                  <div class="card-body">
                    ...
                    <input type="hidden" name="act" value="modOpinions">
                        ...
                        <div class="row">
                          <div class="col-md-9">
                                ...
                                <select class="form-control" name="selectNom" id="selectNom">
                                    ...
                                    <?php 
                                        ...
                                        for($z=0;$z<sizeof($id);$z++)
                                        {
                                          if($id[$z] == $nomW){
                                    ?>
                                          <option value="<?php echo $id[$z] ?>" selected><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php  echo $nom[$z] ?></font></font></option>
                                    <?php }else{ ?>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-md-10">
                                <input type="text" id="title" value="<?php echo $titre; ?>" class="form-control" placeholder="عنوان المقال" name="title">
