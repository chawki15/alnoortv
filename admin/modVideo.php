          ...
          <div class="row breadcrumbs-top">
            ...
            <div class="breadcrumb-wrapper col-12">
              ...
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">تعديل فيديو
                          ...
                          <div class="col-md-9">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-md-10">
                                  ...
                                  <input type="text" id="titleVideo" class="form-control" value='<?php echo $titre; ?>' maxlength="140" placeholder="عنوان الفيديو" name="titleVideo">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-md-10">
                                ...
                                <div class="group-image afficher image-1"  style="background-image:url(<?php echo '../assets/img/videos/'.$photo ?>);">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-md-10">
                                ...
                                <textarea name="desc" id="desc"><?php echo $des ?></textarea>
