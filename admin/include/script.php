...
<?php } if((curPageName()=='addVideo.php')||(curPageName()=='modVideo.php')){ ?>
<script src='assets/jquery-3.3.1.min.js'></script>
...
<?php } if((curPageName()=='addNews.php')||(curPageName()=='modNews.php')){ ?>
<script src='assets/jquery-3.3.1.min.js'></script>
<script src="assets/vendors/js/ckeditor/ckeditor.js"></script>
...
<?php } if((curPageName()=='addOpinions.php')||(curPageName()=='modOpinion.php')){ ?>
<script src='assets/jquery-3.3.1.min.js'></script>
<script src="assets/vendors/js/ckeditor/ckeditor.js"></script>
<script src="assets/writers/script.js"></script>
<script src="assets/jquery-2.2.4.min.js"></script>
<script src="assets/config.js" type="text/javascript"></script>
<?php } if((curPageName()=='addSousCat.php')||(curPageName()=='modSouscat.php')||(curPageName()=='addCat.php')||(curPageName()=='modCat.php')||(curPageName()=='seo.php')||(curPageName()=='addUser.php')){ ?>
<script src="assets/jquery-2.2.4.min.js"></script>
<script src="assets/config.js" type="text/javascript"></script>
<?php } if((curPageName()=='addWriter.php')||(curPageName()=='modWriter.php')){ ?>
<script src="assets/writers/script.js"></script>
<script src="assets/jquery-2.2.4.min.js"></script>
<script src="assets/config.js" type="text/javascript"></script>
<?php } if((curPageName()=='afficherCat.php')||(curPageName()=='afficherSousCat.php')||(curPageName()=='afficherNews.php')
||(curPageName()=='afficherWriter.php')||(curPageName()=='afficherOpinions.php')||(curPageName()=='afficherVideos.php')||(curPageName()=='afficherInfographic.php')){ ?>
