                              ...
                              <select class="form-control" name="selectCategory" id="selectCategory">
                                    ...
                                    ?>
                                          ...
                                          for($j=0;$j<sizeof($idss);$j++)
                                        {
                                          if($idss[$j]== $souscat){
                                    ?> 
                                    <option value="<?php echo $idcats[$j].'#'.$idss[$j] ?>" selected><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php  echo $name[$i].' : '.$nom[$j]; ?></font></font></option>
                                     <?php }else{ ?>
                        ...
                        <div class="row">
                          <div class="col-md-5">
                            ...
                            <div class="form-group row">
                              <div class="col-md">
                                <div class="list">
                                  <div class="group-image <?php if($photo1 != ''){echo 'afficher';} ?> image-2" <?php if($photo1 != ''){ ?> style="background-image:url(<?php echo '../assets/img/news/'.$photo1 ?>);" <?php } ?>>
                        ...
                        <div class="row">
                          <div class="col-md-5">
                            ...
                            <div class="form-group row">
                              <div class="col-md">
                                <div class="list">
                                  <div class="group-image <?php if($photo2 != ''){echo 'afficher';} ?> image-3" <?php if($photo2 != ''){ ?> style="background-image:url(<?php echo '../assets/img/news/'.$photo2 ?>);" <?php } ?>>
                        ...
                        <div class="row">
                          <div class="col-md-5">
                            ...
                            <div class="form-group row">
                              <div class="col-md">
                                <div class="list">
                                  <div class="group-image <?php if($photo3 != ''){echo 'afficher';} ?> image-4" <?php if($photo3 != ''){ ?> style="background-image:url(<?php echo '../assets/img/news/'.$photo3 ?>);" <?php } ?>>
                        ...
                        <div class="row">
                          <div class="col-md-5">
                            ...
                            <div class="form-group row">
                              <div class="col-md">
                                <div class="list">
                                  <div class="group-image <?php if($photo4 != ''){echo 'afficher';} ?> image-5" <?php if($photo4 != ''){ ?> style="background-image:url(<?php echo '../assets/img/news/'.$photo4 ?>);" <?php } ?>>
                        ...
                        <div class="row">
                          <div class="col-md-5">
                            ...
                            <div class="form-group row">
                              <div class="col-md">
                                <div class="list">
                                  <div class="group-image <?php if($photo5 != ''){echo 'afficher';} ?> image-6" <?php if($photo5 != ''){ ?> style="background-image:url(<?php echo '../assets/img/news/'.$photo5 ?>);" <?php } ?>>
