                        ...
                        <div class="row">
                          <div class="col-md-9">
                            <div class="form-group row">
                              ...
                              <select class="form-control" name="selectCategory" id="selectCategory">
                                    ...
                                    ?>
                                        ...
                                        {
                                    ?> 
                                          <option value="<?php echo $idcats[$j].'#'.$idss[$j] ?>" ><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php  echo $name[$i].' : '.$nom[$j]; ?></font></font></option>
                                    <?php }} ?>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-md-10">
                                  <input type="text" id="titleNews" class="form-control" maxlength="140" placeholder="عنوان الخبر" name="titleNews">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="radio-inline">
                                    <input type="radio" name="mustajidaat" id="not" class="ng-pristine ng-untouched ng-valid ng-not-empty" value="1" checked="checked">
                                    <label for="not">&nbsp; لا </label>
                                  </div>
                                  <div class="radio-inline">
                                    <input type="radio" name="mustajidaat" id="yes" class="ng-pristine ng-untouched ng-valid ng-not-empty" value="2">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                <div class="radio-inline">
                                    <input type="radio" name="lastNews" id="no" class="ng-pristine ng-untouched ng-valid ng-not-empty" value="1" checked="checked">
                                    <label for="no">&nbsp; لا </label>
                                  </div>
                                  <div class="radio-inline">
                                    <input type="radio" name="lastNews" id="oui" class="ng-pristine ng-untouched ng-valid ng-not-empty" value="2">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                <div class="radio-inline">
                                    <input type="radio" name="urgent" id="nicht" class="ng-pristine ng-untouched ng-valid ng-not-empty" value="1" checked="checked">
                                    <label for="nicht">&nbsp; لا </label>
                                  </div>
                                  <div class="radio-inline">
                                    <input type="radio" name="urgent" id="ja" class="ng-pristine ng-untouched ng-valid ng-not-empty" value="2">
                                    <label for="ja">&nbsp; نعم </label>
                                  </div>
                                </div>
                            </div>
                            <div class="form-group row">
                              ...
                              <div class="col-md-10">
                                  <input type="text" id="auteur" class="form-control" maxlength="140" placeholder="صاحب الخبر أو المصدر" name="auteur">
                              ...
                              <div class="col-md-10">
                                <div class="list">
                                  <div class="group-image image-1">
                                    ...
                                    <input type="hidden" id="photoNews" name="photoNews" value="">
                      ...
                      <div class="form-body">
                        ...
                        <div class="row">
                          <div class="col-md-5">
                            <div class="form-group row">
                              <div class="col-md">
                                <input type="text" id="descphoto2" class="form-control" placeholder="وصف الصورة" name="descphoto2">
                                ...
                                <div class="list">
                                  <div class="group-image image-2">
                                    ...
                                    <div class="description" id="desc-2">
                                     ...
                                     <input type="hidden" id="photoNews2" name="photoNews2" value="">
                          ...
                          <div class="col-md-7">
                            <fieldset class="form-group form-group-style">
                              ...
                              <textarea class="form-control" name="smpost2" id="smpost2" rows="3" style="direction: initial;"></textarea>
                            </fieldset>
                            <div class="form-group row">
                              <div class="col-md-12">
                      ...
                      <div class="form-body">
                        ...
                        <div class="row">
                          <div class="col-md-5">
                            <div class="form-group row">
                              <div class="col-md">
                                <input type="text" id="descphoto3" class="form-control" placeholder="وصف الصورة" name="descphoto3">
                              ...
                              <div class="col-md">
                                <div class="list">
                                  <div class="group-image image-3">
                                    ...
                                    <input type="hidden" id="photoNews3" name="photoNews3" value="">
                          ...
                          <div class="col-md-7">
                            <fieldset class="form-group form-group-style">
                              <label for="textarea2">منشور مُضمن Facebook Tweeter Instagram </label>
                              <textarea class="form-control" name="smpost3" id="smpost3" rows="3" style="direction: initial;"></textarea>
                            </fieldset>
                            <div class="form-group row">
                              <div class="col-md-12">
                               <textarea name="desc3" id="desc3"></textarea>
                      ...
                      <div class="form-body">
                        ...
                        <div class="row">
                          <div class="col-md-5">
                            <div class="form-group row">
                              <div class="col-md">
                                <input type="text" id="descphoto4" class="form-control" placeholder="وصف الصورة" name="descphoto4">
                              ...
                              <div class="col-md">
                                <div class="list">
                                  <div class="group-image image-4">
                                    ...
                                    <input type="hidden" id="photoNews4" name="photoNews4" value="">
                          ...
                          <div class="col-md-7">
                            <fieldset class="form-group form-group-style">
                              <label for="textarea2">منشور مُضمن Facebook Tweeter Instagram </label>
                              <textarea class="form-control" name="smpost4" id="smpost4" rows="3" style="direction: initial;"></textarea>
                            </fieldset>
                            <div class="form-group row">
                              <div class="col-md-12">
                               <textarea name="desc4" id="desc4"></textarea>
                      ...
                      <div class="form-body">
                        ...
                        <div class="row">
                          <div class="col-md-5">
                            <div class="form-group row">
                              <div class="col-md">
                                <input type="text" id="descphoto5" class="form-control" placeholder="وصف الصورة" name="descphoto5">
                              ...
                              <div class="col-md">
                                <div class="list">
                                  <div class="group-image image-5">
                                    ...
                                    <input type="hidden" id="photoNews5" name="photoNews5" value="">
                          ...
                          <div class="col-md-7">
                            <fieldset class="form-group form-group-style">
                              <label for="textarea2">منشور مُضمن Facebook Tweeter Instagram </label>
                              <textarea class="form-control" name="smpost5" id="smpost5" rows="3" style="direction: initial;"></textarea>
                            </fieldset>
                            <div class="form-group row">
                              <div class="col-md-12">
                               <textarea name="desc5" id="desc5"></textarea>
                      ...
                      <div class="form-body">
                        ...
                        <div class="row">
                          <div class="col-md-5">
                            <div class="form-group row">
                              <div class="col-md">
                                <input type="text" id="descphoto6" class="form-control" placeholder="وصف الصورة" name="descphoto6">
                            ...
                            <div class="form-group row">
                              <div class="col-md">
                                <div class="list">
                                  <div class="group-image image-6">
                                    <input name="6" onchange="readURL6();" id="6" type="file" accept="image/jpeg,image/png">
                                    <div id="progress-wrp6"><div class="progress-bar6"></div ><div class="status6">0%</div></div>
                                    ...
                                    <input type="hidden" id="photoNews6" name="photoNews6" value="">
                          ...
                          <div class="col-md-7">
                            <fieldset class="form-group form-group-style">
                              <label for="textarea2">منشور مُضمن Facebook Tweeter Instagram </label>
                              <textarea class="form-control" name="smpost6" id="smpost6" rows="3" style="direction: initial;"></textarea>
                            </fieldset>
                            <div class="form-group row">
                              <div class="col-md-12">
                               <textarea name="desc6" id="desc6"></textarea>
