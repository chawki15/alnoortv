    ...
    <div class="content-wrapper">
        <div class="content-header row">
          ...
          <div class="content-header-right col-md-2 col-12 btn-add">
            <a class="btn btn-sm round btn-danger btn-glow" href="addSouscat.php">إضافة فئة فرعية جديدة</a>
          </div>
      </div>
                       ...
                       <?php list($id,$idcat,$name) = GetAdminSousMenu($pdo); for($i=0;$i<sizeof($id);$i++){ ?>
                        <tr>
                          ...
                          <td>
                            ...
                            <a class="btn btn-sm btn-outline-warning round" href="seo.php?s=<?php  echo $id[$i];?>&v=souscat">السيو</a>
                          </td>
                        </tr>
                       <?php } ?>
                      </tbody>
